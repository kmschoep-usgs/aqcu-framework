...
public class RequestParametersValidationTest {
	...
	public void emptyRequestParameters() {
		...
		assertValidationResults(validationErrors,
				"primaryTimeseriesIdentifier:may not be null",
				":Missing information required to build report time period. Must include at least one of: [lastMonths, waterYear, {startDate, endDate}].");
	}
